        ...
        <div className="flex flex-col md:flex-row items-start justify-between w-full">
          ...
          >
            ...
            <h3 className="text-2xl font-semibold text-gray-700 mt-2">
              Acupuncture & Bien-être
            </h3>
            <p className="text-lg text-gray-700 leading-relaxed mt-4">
              "Je suis une professionnelle qualifiée avec plus de 16 ans d'expérience
              dans les soins de santé, spécialisée en acupuncture traditionnelle
              chinoise, massage thérapeutique, et bien-être. Mon objectif est de
              vous guider vers un équilibre physique et énergétique, en harmonie
              avec votre esprit."
            </p>
          </motion.div>
        ...
        >
          <div className="bg-[#ffffff] p-6 rounded-lg shadow-md">
            ...
            <ul className="text-gray-600 list-disc list-inside">
              <li>Titre de Technicienne en Acupuncture, 2009 (1600h)</li>
              <li>Shiatsu Koho-Igaku, 2008 (725h)</li>
              <li>Manipulation Vertébrale et Esthétique Médicale</li>
            </ul>
          </div>
          ...
          <div className="bg-[#ffffff] p-6 rounded-lg shadow-md">
            ...
            <ul className="text-gray-600 list-disc list-inside">
              ...
              <li>+6000 patients satisfaits</li>
              <li>Soins spécialisés pour adultes, enfants, et post-cancer</li>
            </ul>
          </div>
        </motion.div>
      </div>
